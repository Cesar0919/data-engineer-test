-- =========================================
-- Q1: Top 10 cuentas con mayor monto total rechazado en los �ltimos 7 d�as
-- =========================================
...
-- =========================================
-- Q3: Regla m�s frecuente por pa�s, usando window functions (RANK() o ROW_NUMBER())
-- =========================================
...
-- =========================================
-- Q4: Cuentas con m�s de 3 transacciones REVIEW en las �ltimas 24 horas (query de alerta)
-- =========================================
